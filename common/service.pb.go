...
const (
	...
	BackendType_OPENVPN BackendType = 1000
)
...
const file_common_service_proto_rawDesc = "" +
	...
	"\x06target\x18\x02 \x01(\tR\x06target*4\n" +
	"\vBackendType\x12\b\n" +
	"\x04XRAY\x10\x00\x12\r\n" +
	"\tWIREGUARD\x10\x01\x12\f\n" +
	"\aOPENVPN\x10\xe8\a*_\n" +
	"\bStatType\x12\r\n" +
